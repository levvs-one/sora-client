...
- импорт ссылок VMess, VLESS, Trojan, Shadowsocks и SOCKS;
...
- монохромный интерфейс без системных экранов WinForms.

## Установка

1. Откройте [последний релиз](https://github.com/levvs-one/sora-client/releases/latest).
2. Скачайте `Sora-0.1.0-Win7-x86-Setup.exe`.
3. Сверьте SHA-256 с файлом `Sora-0.1.0-SHA256SUMS.txt`.
