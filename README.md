...
<p align="center">
  Клиент подписок и подключений для Windows 7 SP1 x86, сделанный в духе Happ.
</p>
...
В клиенте есть системный прокси, проверка задержки, автообновление подписок и фильтруемый журнал. Установщик рассчитан на Windows 7 SP1 x86 и при необходимости предлагает системные компоненты, нужные для запуска.
...
2. Скачай установщик для Windows 7 x86 и запусти его.
...
dotnet build .\v2rayN\v2rayN\v2rayN.csproj --configuration Release --runtime win7-x86 --no-restore --property:Platform=x86
```
