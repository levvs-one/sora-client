...
2. Скачайте `Sora-0.2.2-Win7-x86-Setup.exe`.
3. Сверьте SHA-256 с файлом `Sora-0.2.2-SHA256SUMS.txt`.
...
Подробности выпусков: [Sora 0.2.2](docs/releases/0.2.2.md), [Sora 0.2.1](docs/releases/0.2.1.md), [Sora 0.2.0](docs/releases/0.2.0.md) и [Sora 0.1.0](docs/releases/0.1.0.md).
